    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
        ...
        <div class="collapse navbar-collapse" id="navbarNav" style="margin-left: 0.5rem;">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="home.php" style="color: #252525;"><b>Home</b></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="belanja.php" style="color: rgba(227, 224, 243, 1);"><b>Shopping</b></a>
                </li>
                <li class="nav-item">
    ...
    <div class="container" style="margin-left: 80px;">
        <div class="row">
            <div class="col-sm-6" style="text-align: justify;">
                <h1> <b> Personal Financial Helper </b></h1>
                <h1 style="color: #8083FF;"> <b> for Kids </b></h1>
                <h4> KIDDY BANK Penerapan teknologi sebagai sarana edukasi bagi literasi finansial anak 
                    yang dapat dapat membantu anak maupun orang tua terkait pendidikan literasi finansial sejak dini. </h5>
                <a href="#" class="btn btn-success btn-lg active text-dark" role="button" aria-pressed="true" style="background-color:#26E0AC;">Get Started</a>
                <a href="aboutus.php" class="btn btn-light btn-lg active text-dark" role="button" aria-pressed="true" style="margin-left: 1rem;">Learn More</a>
            </div>
        </div>
    </div>
